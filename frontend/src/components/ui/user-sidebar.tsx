  ...
  return (
    <>
      <button
        ...
        className="rounded-full p-1 bg-gray-200 hover:bg-gray-300 transition-all mr-8 ml-24 max-md:ml-0 max-md:mr-0"
      >
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-[9999]">
            <div className="bg-white border border-gray-200 rounded-3xl shadow-xl p-8 w-[500px]">
              ...
              <div className="flex flex-col items-center mt-6 gap-4">
                ...
                <label className="cursor-pointer rounded-[8px] flex items-center gap-2 text-sm px-4 py-2 bg-white border border-gray-300 shadow-sm hover:bg-gray-100 transition-all">
              ...
              <div className="mt-8 flex justify-center gap-4">
                <Button
                  ...
                  className="w-32 h-22 px-8 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <button
                  className="w-32 px-6 py-2 bg-red-600 text-white rounded-full hover:bg-red-500 transition-all"
